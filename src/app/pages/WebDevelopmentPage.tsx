...
export function WebDevelopmentPage() {
  ...
  const faqItems = getServiceFAQ('web-development', language);

  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": language === "pt" ? "Criação de Sites Profissionais" : "Professional Website Creation",
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] transition-colors duration-300">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2.5 md:p-3 bg-[#2f5e50]/10 border border-[#2f5e50]/20">
                <Globe className="w-5 md:w-6 h-5 md:h-6 text-[#2f5e50]" aria-hidden="true" />
              </div>
              <span className="text-[#2f5e50] font-bold text-[9px] md:text-[10px] uppercase tracking-widest">
                {language === "pt" ? "Criação de Sites" : "Website Creation"}
              </span>
            </div>
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-neutral-100 mb-4 md:mb-6 tracking-tight" id="hero-title">
              {language === "pt" 
                ...
                : "Professional Website Creation in Portugal"}
            </h1>
        ...
        <div className="container mx-auto px-3 md:px-6 max-w-7xl">
          <div className="mb-8 md:mb-12">
            ...
            <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight">
              {language === "pt" ? "Funcionalidades do site profissional" : "Professional website features"}
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div>
              ...
              <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight mb-4 md:mb-6">
                {language === "pt" 
                  ? "Vantagens da criação de sites com a Strict.Dev"
                  : "Benefits of website creation with Strict.Dev"}
              </h2>
      ...
      {/* Process Section */}
      <section className="py-12 md:py-20 bg-neutral-50 dark:bg-[#0f0f0f]" aria-labelledby="process-title">
        <div className="container mx-auto px-3 md:px-6 max-w-7xl">
          <div className="mb-8 md:mb-12">
            <span className="text-[#2f5e50] font-bold text-[9px] md:text-[10px] uppercase tracking-widest mb-2 block">
              {language === "pt" ? "Processo" : "Process"}
            </span>
            <h2 id="process-title" className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight">
      ...
      <RelatedServices currentService="web-development" language={language} />
