...
export function EcommercePage() {
  ...
  const faqItems = getServiceFAQ('ecommerce', language);

  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": language === "pt" ? "Criação de Loja Online" : "Online Store Creation",
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] transition-colors duration-300">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2.5 md:p-3 bg-[#2f5e50]/10 border border-[#2f5e50]/20">
                <ShoppingBag className="w-5 md:w-6 h-5 md:h-6 text-[#2f5e50]" aria-hidden="true" />
              </div>
            ...
            >
              {language === "pt" 
                ? "Criação de Loja Online Profissional em Portugal"
                : "Professional Online Store Creation in Portugal"}
            </h1>
        ...
        <div className="container mx-auto px-3 md:px-6 max-w-7xl">
          <div className="mb-8 md:mb-12">
            ...
            <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight">
              {language === "pt" ? "Funcionalidades da loja online" : "Online store features"}
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div>
              ...
              <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight mb-4 md:mb-6">
                {language === "pt" 
                  ? "Vantagens do e-commerce profissional"
                  : "Benefits of professional e-commerce"}
              </h2>
      ...
      <RelatedServices currentService="ecommerce" language={language} />
