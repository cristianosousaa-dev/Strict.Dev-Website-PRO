...
export function AIAgentsPage() {
  ...
  const faqItems = getServiceFAQ('ai-agents', language);

  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": language === "pt" ? "Chatbot com Inteligência Artificial" : "AI Chatbot for Business",
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] transition-colors duration-300">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2.5 md:p-3 bg-[#2f5e50]/10 border border-[#2f5e50]/20">
                <Bot className="w-5 md:w-6 h-5 md:h-6 text-[#2f5e50]" aria-hidden="true" />
              </div>
            ...
            <h1 className="text-2xl md:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-neutral-100 mb-4 md:mb-6 tracking-tight" id="hero-title">
              {language === "pt" 
                ...
                : "AI Chatbot for Business in Portugal"}
            </h1>
        ...
        <div className="container mx-auto px-3 md:px-6 max-w-7xl">
          <div className="mb-8 md:mb-12">
            ...
            <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight">
              {language === "pt" ? "Funcionalidades do chatbot IA" : "AI chatbot features"}
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div>
              ...
              <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight mb-4 md:mb-6">
                {language === "pt" 
                  ? "Vantagens da automação com inteligência artificial"
                  : "Benefits of automation with artificial intelligence"}
              </h2>
      ...
      <RelatedServices currentService="ai-agents" language={language} />
