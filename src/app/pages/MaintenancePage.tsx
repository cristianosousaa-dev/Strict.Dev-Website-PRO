...
export function MaintenancePage() {
  ...
  const faqItems = getServiceFAQ('maintenance', language);

  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": language === "pt" ? "Manutenção de Websites" : "Website Maintenance",
    "description": metadata.description,
    "provider": { "@type": "ProfessionalService", "name": "Strict.Dev", "url": "https://strict-dev.com" },
    "areaServed": { "@type": "Country", "name": "Portugal" },
    "url": "https://strict-dev.com/servicos/manutencao"
  };
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2.5 md:p-3 bg-[#2f5e50]/10 border border-[#2f5e50]/20">
                <Cpu className="w-5 md:w-6 h-5 md:h-6 text-[#2f5e50]" aria-hidden="true" />
              </div>
            ...
            >
              {language === "pt" 
                ? "Manutenção de Websites Profissional em Portugal"
                : "Professional Website Maintenance in Portugal"}
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div>
              ...
              <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight mb-4 md:mb-6">
                {language === "pt" 
                  ? "Vantagens da manutenção profissional de websites"
      ...
      <section className="py-12 md:py-20 bg-neutral-50 dark:bg-[#0f0f0f]">
        <div className="container mx-auto px-3 md:px-6 max-w-7xl">
          <div className="mb-8 md:mb-12">
            ...
            <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight">
              {language === "pt" ? "Serviços de manutenção incluídos" : "Included maintenance services"}
            </h2>
          </div>
      ...
      <RelatedServices currentService="maintenance" language={language} />
