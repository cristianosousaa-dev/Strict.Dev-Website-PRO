...
export function InfrastructurePage() {
  ...
  const faqItems = getServiceFAQ('infrastructure', language);

  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "name": language === "pt" ? "Hosting Cloud Profissional" : "Professional Cloud Hosting",
    "description": metadata.description,
    "provider": { "@type": "ProfessionalService", "name": "Strict.Dev", "url": "https://strict-dev.com" },
    "areaServed": { "@type": "Country", "name": "Portugal" },
    "url": "https://strict-dev.com/servicos/infraestrutura"
  };
  ...
  const features = [
    {
      icon: Cloud,
      title: language === "pt" ? "Infraestrutura Cloud" : "Cloud Infrastructure",
      desc: language === "pt" 
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2.5 md:p-3 bg-[#2f5e50]/10 border border-[#2f5e50]/20">
                <Server className="w-5 md:w-6 h-5 md:h-6 text-[#2f5e50]" aria-hidden="true" />
              </div>
            ...
            >
              {language === "pt" 
                ? "Hosting Cloud Profissional em Portugal"
                : "Professional Cloud Hosting in Portugal"}
            </h1>
        ...
        <div className="container mx-auto px-3 md:px-6 max-w-7xl">
          <div className="mb-8 md:mb-12">
            ...
            <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight">
              {language === "pt" ? "Funcionalidades do hosting cloud" : "Cloud hosting features"}
            </h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            <div>
              ...
              <h2 className="text-xl md:text-3xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight mb-4 md:mb-6">
                {language === "pt" 
                  ? "Vantagens do hosting cloud profissional"
                  : "Benefits of professional cloud hosting"}
              </h2>
      ...
      <RelatedServices currentService="infrastructure" language={language} />
