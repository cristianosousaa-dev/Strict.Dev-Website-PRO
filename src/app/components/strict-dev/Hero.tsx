...
export function Hero({ onShowAnimation, shouldHideCore, showAnimation, onCloseAnimation }: HeroProps) {
  ...
  return (
    <section className="relative pt-0 pb-10 md:pt-24 md:pb-16 lg:pt-32 px-3 md:px-6 bg-white dark:bg-[#0a0a0a] min-h-screen flex flex-col justify-center overflow-hidden border-b border-neutral-200 dark:border-[#1a1a1a]">
      ...
      <div className="container mx-auto max-w-7xl relative z-30 pointer-events-auto">
        ...
        <motion.div
          ...
          className="md:hidden mb-8 flex justify-center pointer-events-auto relative z-40"
        >
          <Logo className="h-32 w-auto object-contain" />
        </motion.div>
        
        {/* Technical Frame Layout */}
        <div className="relative border-l-2 border-neutral-200 dark:border-[#1a1a1a] pl-3 md:pl-8 lg:pl-16 py-6 md:py-0 pointer-events-auto z-40">
            
            {/* Corner Markers (Blueprint Style) */}
            <div className="absolute -top-1 -left-[2px] w-3 md:w-4 h-[2px] bg-[#2f5e50]"></div>
            <div className="absolute -top-1 -left-[2px] w-[2px] h-3 md:h-4 bg-[#2f5e50]"></div>
            <div className="absolute -bottom-1 -left-[2px] w-3 md:w-4 h-[2px] bg-[#2f5e50]"></div>
            <div className="absolute -bottom-1 -left-[2px] w-[2px] h-3 md:h-4 bg-[#2f5e50]"></div>
