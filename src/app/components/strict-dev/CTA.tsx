...
export function CTA() {
  ...
  const itemVariants = {
    hidden: { opacity: 0, y: 30, scale: 0.97, rotateX: 8 },
    visible: { 
      opacity: 1, 
      y: 0, 
      scale: 1,
  ...
  return (
    <section className="relative bg-white dark:bg-[#0a0a0a] py-10 md:py-16 px-3 md:px-6 border-t border-b border-neutral-100 dark:border-[#1a1a1a] overflow-hidden" aria-labelledby="cta-title">
        ...
        >
            ...
            >
                ...
                <motion.div 
                  className="inline-flex items-center gap-1.5 md:gap-2 py-1 md:py-1.5 px-2 md:px-3 border-2 border-[#2f5e50] bg-[#2f5e50]/5 text-[#2f5e50] text-[8px] md:text-[10px] font-bold uppercase tracking-widest mb-2 md:mb-4"
                  variants={itemVariants}
                >
                ...
                <motion.div variants={itemVariants}>
                  <Button 
                    asChild
                    className="h-9 md:h-12 px-5 md:px-8 bg-[#2f5e50] hover:bg-[#234539] dark:hover:bg-[#1a4237] text-white text-[8px] md:text-[10px] font-bold uppercase tracking-widest rounded-none shadow-lg hover:shadow-xl hover:scale-105 cursor-pointer group"
                    style={{
                ...
                {/* Trust Signals */}
                <motion.div 
                  className="mt-3 md:mt-7 pt-2.5 md:pt-6 border-t border-neutral-200 dark:border-[#1a1a1a] flex flex-wrap justify-center gap-2 md:gap-8 text-[9px] md:text-xs text-neutral-500 dark:text-neutral-400"
                  variants={itemVariants}
                >
