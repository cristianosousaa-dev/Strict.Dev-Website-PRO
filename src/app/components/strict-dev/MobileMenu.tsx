    ...
    <>
      ...
      >
        ...
        <div className="relative p-6 border-b border-neutral-200 dark:border-[#1a1a1a] bg-neutral-50 dark:bg-[#0f0f0f]">
          ...
          >
            <X className="w-5 h-5 text-neutral-700 dark:text-neutral-300" aria-hidden="true" />
          </button>
          <div className="flex justify-center mb-4">
            <img src={logo} alt="Strict.Dev" className="h-14 w-auto" width="140" height="56" />
          </div>
        ...
        <nav className="flex flex-col p-6">
            ...
            <div className="space-y-1">
              ...
              <div>
                ...
                >
                  ...
                  <ChevronDown className={`w-3 h-3 transition-transform duration-200 ${servicesOpen ? 'rotate-180' : ''}`} aria-hidden="true" />
                </button>
          ...
          >
            <a href="#contact" onClick={(e) => handleLinkClick(e, '#contact')}>
              {t.mobileMenu.cta}
              <FileText className="w-3 h-3 ml-2" aria-hidden="true" />
            </a>
          </Button>
          ...
          <div className="mt-auto pt-6 border-t border-neutral-200 dark:border-[#1a1a1a]">
            <p className="text-[9px] text-center text-neutral-400 uppercase tracking-wider">
              © 2026 Strict.Dev. {t.footer.copyright}
            </p>
          </div>
        </nav>
      </div>
