    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 id="configurator-title" className="text-xl md:text-2xl font-bold uppercase tracking-tight text-neutral-900 dark:text-neutral-100 mb-1">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-end justify-between gap-1.5 md:gap-2 pt-1.5 md:pt-2 border-t border-current/10 mt-auto w-full">
                  <div>
                    <div className={`text-[8px] md:text-[9px] uppercase tracking-wide mb-0.5 ${active ? 'text-white/50' : 'text-neutral-400'}`}>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-1.5 md:gap-3 mb-1.5 md:mb-3">
                ...
                <div className="flex items-center gap-1.5 md:gap-4">
                  <div>
                    <div className="text-[8px] md:text-[9px] uppercase tracking-wide text-white/40 mb-0.5 md:mb-1">
              ...
              {/* Disclaimer */}
              <p className="text-[8px] md:text-[9px] leading-relaxed text-white/50 pt-1 md:pt-2 border-t border-white/10">
