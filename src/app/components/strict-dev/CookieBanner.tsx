          ...
          <div className="space-y-2 md:space-y-4">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-1.5 md:gap-3">
              ...
              <div className="text-center md:text-left flex-1">
                <h3 className="font-semibold text-slate-900 dark:text-neutral-100 text-[0.6875rem] md:text-sm mb-0.5 md:mb-1">
                  {t.cookies.title}
                </h3>
                <p className="text-[0.5625rem] md:text-xs text-slate-600 dark:text-neutral-400 leading-snug md:leading-relaxed">
            ...
            <div className="flex flex-col gap-1.5 md:gap-2">
              <Button
                onClick={acceptAll}
                size="sm"
                className="w-full bg-[#2f5e50] hover:bg-[#254a3d] text-white rounded-none text-[0.625rem] md:text-xs h-7 md:h-9"
              >
                {t.cookies.acceptAll}
              </Button>
              <div className="grid grid-cols-2 gap-1.5 md:gap-2">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="rounded-none border-slate-300 hover:border-slate-400 text-[0.625rem] md:text-xs h-7 md:h-9"
                >
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  className="rounded-none border-slate-300 hover:border-[#2f5e50] hover:text-[#2f5e50] text-[0.625rem] md:text-xs h-7 md:h-9"
                >
          ...
          <div className="space-y-2 md:space-y-4">
            ...
            <div className="space-y-1.5 md:space-y-2">
              <div className="flex items-start justify-between p-2 md:p-3 bg-slate-50 dark:bg-[#0a0a0a] border border-slate-100 dark:border-[#2a2a2a] rounded-none">
                <div className="flex-1">
                  <h4 className="font-medium text-slate-900 dark:text-neutral-100 text-[0.625rem] md:text-xs mb-0.5">
                    {t.cookies.necessary}
                  </h4>
                  <p className="text-[0.5625rem] md:text-xs text-slate-600 dark:text-neutral-400 leading-tight md:leading-normal">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                size="sm"
                className="w-full bg-[#2f5e50] hover:bg-[#254a3d] text-white rounded-none text-[0.625rem] md:text-xs h-8 md:h-9"
              >
              ...
              <Button
                ...
                variant="outline"
                size="sm"
                className="w-full rounded-none border-slate-300 hover:border-slate-400 text-[0.625rem] md:text-xs h-8 md:h-9"
              >
                {t.cookies.acceptNecessary}
              </Button>
            </div>
