      ...
      <DialogContent className="max-w-[85vw] md:max-w-lg rounded-none p-4 md:p-6">
        <DialogHeader>
          <div className="flex items-center gap-1.5 md:gap-2 mb-1.5 md:mb-2">
            <Cookie className="w-4 h-4 md:w-5 md:h-5 text-[#2f5e50]" aria-hidden="true" />
            <DialogTitle className="text-sm md:text-lg font-semibold text-slate-900 dark:text-neutral-100">
              {t.cookies.modalTitle}
            </DialogTitle>
          </div>
          <DialogDescription className="text-[0.625rem] md:text-xs text-slate-600 dark:text-neutral-400 leading-snug md:leading-normal">
        ...
        <div className="space-y-2 md:space-y-3 my-3 md:my-4">
          <div className="flex items-start justify-between p-2.5 md:p-4 bg-slate-50 dark:bg-[#0f0f0f] rounded-none border border-slate-200 dark:border-[#2a2a2a]">
            <label htmlFor="modal-cookie-necessary" className="flex-1 cursor-default">
              <h4 className="font-medium text-slate-900 dark:text-neutral-100 text-[0.6875rem] md:text-sm mb-0.5 md:mb-1">
                {t.cookies.necessaryTitle}
              </h4>
              <p className="text-[0.5625rem] md:text-xs text-slate-600 dark:text-neutral-400 leading-tight md:leading-relaxed">
          ...
          <div className="flex items-start justify-between p-2.5 md:p-4 bg-slate-50 dark:bg-[#0f0f0f] rounded-none border border-slate-200 dark:border-[#2a2a2a]">
            <label htmlFor="modal-cookie-analytics" className="flex-1 cursor-pointer">
              <h4 className="font-medium text-slate-900 dark:text-neutral-100 text-[0.6875rem] md:text-sm mb-0.5 md:mb-1">
          ...
          <div className="flex items-start justify-between p-2.5 md:p-4 bg-slate-50 dark:bg-[#0f0f0f] rounded-none border border-slate-200 dark:border-[#2a2a2a]">
            <label htmlFor="modal-cookie-marketing" className="flex-1 cursor-pointer">
              <h4 className="font-medium text-slate-900 dark:text-neutral-100 text-[0.6875rem] md:text-sm mb-0.5 md:mb-1">
