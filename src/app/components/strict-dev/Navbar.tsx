...
import { getServiceNavItems } from "../../../data/servicesNav";
...
export function Navbar() {
  ...
  const services = getServiceNavItems(language);
  ...
  return (
    <>
      <nav
        className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-[#0a0a0a] backdrop-blur-md border-b border-neutral-200 dark:border-[#1a1a1a] h-14 md:h-20 transition-all duration-300"
          ...
          <div className="flex md:hidden items-center gap-1 h-full flex-1">
            {[
              ...
              <a
                key={idx}
                href={item.href}
                aria-label={language === "pt" ? `Navegar para secção ${item.label}` : `Navigate to ${item.label} section`}
          ...
          <div className="hidden lg:flex items-center gap-1 h-full">
            ...
            >
              ...
              {servicesDropdownOpen && (
                <div className="absolute top-full left-0 w-64 bg-white dark:bg-[#0a0a0a] border border-neutral-200 dark:border-[#1a1a1a] shadow-lg z-50" role="menu">
          ...
          <div className="flex items-center gap-2 md:gap-6 md:pl-6 md:border-l md:border-neutral-100 md:dark:border-[#1a1a1a] h-full">
            ...
            >
              <a href="#contact" onClick={(e) => handleNavClick(e, "#contact")}>
                {t.nav.cta}
                <FileText className="w-3 h-3 ml-2 group-hover:scale-110 transition-transform" aria-hidden="true" />
              </a>
            </Button>
            ...
            <Button
              ...
              aria-label={language === "pt" ? "Abrir menu de navegação" : "Open navigation menu"}
            >
              <Menu className="w-5 h-5 text-neutral-700 dark:text-neutral-300" aria-hidden="true" />
            </Button>
