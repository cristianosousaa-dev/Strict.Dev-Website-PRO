...
export function Compliance() {
  ...
  return (
    <section className="bg-white dark:bg-[#0a0a0a] py-12 md:py-20" id="compliance" aria-labelledby="compliance-title">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            >
                <motion.div variants={itemVariants}>
                    <span className="inline-block py-1 px-2.5 md:px-3 border border-[#2f5e50] text-[#2f5e50] text-[0.5625rem] md:text-[9px] font-bold uppercase tracking-widest mb-3 md:mb-4 bg-white dark:bg-[#0a0a0a]">
                        {t.compliance.badge}
                    </span>
                    <h2 id="compliance-title" className="text-xl md:text-3xl lg:text-4xl font-bold text-neutral-900 dark:text-neutral-100 tracking-tight leading-tight">
                        {t.compliance.title}
                    </h2>
                </motion.div>
                ...
                >
                    ...
                    >
                        ...
                        >
                          <ShieldCheck className="w-5 h-5 md:w-6 md:h-6 mb-2 md:mb-2.5 stroke-[1.5]" aria-hidden="true" />
                        </motion.div>
                    ...
                    >
                        <motion.div 
                          ...
                          className="text-neutral-400 dark:text-neutral-600 hover:text-[#2f5e50]"
                        >
                          <FileSearch className="w-5 h-5 md:w-6 md:h-6 mb-2 md:mb-2.5 stroke-[1.5]" aria-hidden="true" />
                        </motion.div>
                ...
                <motion.div variants={itemVariants}>
                    ...
                    >
                        <a href="#contact">
                            {t.compliance.cta}
                            <Lock className="w-3 h-3 ml-2 group-hover:scale-110 transition-transform" aria-hidden="true" />
                        </a>
                    </Button>
                </motion.div>
            </motion.div>
            ...
            <motion.div 
              className="relative order-1 lg:order-2 bg-white dark:bg-[#0a0a0a] p-6 md:p-10 border border-neutral-200 dark:border-[#1a1a1a] shadow-sm overflow-hidden"
                ...
                <div className="space-y-4 md:space-y-6">
                    ...
                    <div className="space-y-2.5 md:space-y-3">
                        {t.compliance.features.map((feature, idx) => (
                            ...
                            >
                                <Check className="w-3.5 h-3.5 md:w-4 md:h-4 text-[#2f5e50] flex-shrink-0 mt-0.5" aria-hidden="true" />
